...
const Grafika4 = () => {
    return (
        <div className='relative'>
            <div className='bg-[#201D47] h-[1024px] text-white pl-12 font-inter'>
                ...
                <div>
                    <div className='w-[1000px]'>
                        ...
                        <div className='bg-white opacity-20 h-[472px] rounded-lg mt-5 text-black'>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='absolute top-[450px] left-14'>
                <img src="src/assets/base.png" alt="" />
            </div>
            <div className='absolute top-[450px] left-64'>
                <img src="src/assets/base.png" alt="" />
            </div>
            <div className='absolute top-[450px] left-[456px]'>
                <img src="src/assets/base.png" alt="" />
            </div>
            <div className='absolute top-[450px] left-[656px]'>
                <img src="src/assets/image9.png" alt="" />
            </div>
            <div className='absolute top-[450px] left-[815px]'>
